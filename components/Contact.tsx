...
const Contact: React.FC = () => {
  return (
    <footer id="contact" className="bg-slate-950 pt-24 pb-12 border-t border-white/5 relative overflow-hidden">
      {/* Footer Gradient */}
      <div className="absolute bottom-0 left-0 right-0 h-[500px] bg-gradient-to-t from-primary/5 to-transparent pointer-events-none"></div>
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          ...
          <div>
            ...
            <div className="space-y-4">
              <a 
                ...
                className="group flex items-center justify-between p-5 rounded-2xl bg-slate-900/50 border border-white/5 hover:bg-slate-800 hover:border-primary/30 transition-all duration-300"
              >
              ...
              <a 
                ...
                className="group flex items-center justify-between p-5 rounded-2xl bg-slate-900/50 border border-white/5 hover:bg-slate-800 hover:border-secondary/30 transition-all duration-300"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-slate-800 flex items-center justify-center text-secondary group-hover:bg-secondary group-hover:text-white transition-colors">
                    <Phone size={20} />
                  </div>
                  <div>
              ...
              <div className="flex items-center gap-4 p-5 rounded-2xl bg-slate-900/50 border border-white/5">
          ...
          <form className="glass p-8 md:p-10 rounded-3xl border border-white/10 shadow-2xl" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full bg-slate-950/50 border border-slate-700 rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-400 ml-1">Your Email</label>
                  <input type="email" className="w-full bg-slate-950/50 border border-slate-700 rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" placeholder="john@example.com" />
                </div>
              </div>
              
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-400 ml-1">Message</label>
                <textarea rows={4} className="w-full bg-slate-950/50 border border-slate-700 rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all resize-none" placeholder="Tell me about your project..."></textarea>
              </div>
